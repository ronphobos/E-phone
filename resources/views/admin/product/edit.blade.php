...
@section('container.product.modifie')
        ...
        <div class="content-central">
            ...
            <div class="content_info">
                ...
                <div class="paddings-mini">
                    <div class="container">
                        <div class="row">
                            <form action="{{ route('produit.update',$id->id ) }}" enctype="multipart/form-data" method="post" id="changelocationform">
                                @csrf
                                @method('patch')
                                <div class="col-md-10">
                                    <aside class="addlocation">
                                        <h4>Ajout<input type="submit" class="btn btn-primary pull-right"
                                                name="submit" value="APPLIQUER LES MODIFICATIONS"></h4>
                                        <address>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" value="{{ $id->price }}" id="route" name="price">
                                            </div>
                                            <div class="form-group">
                                                <label for="city" class="col-form-label">Description</label>
                                                <input type="text" value="{{ $id->description }}" class="form-control" id="locality" name="description">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category" id="administrative_area_level_1">
                                                    ...
                                                    <option value="{{ $id->category }}">{{ $categorie->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="country" class="col-form-label">Photo</label>
                                                <input type="file" class="form-control" value="{{ $id->photo }}"  id="country" name="photo">
                                            </div>
                                            {{-- <input type="hidden" class="form-control"  id="country" name="category_id"> --}}
                                            <div class="form-group">
                                                <label for="pincode" class="col-form-label">Mot clé:</label>
                                                <input type="text" value="{{ $id->mot_cle }}" class="form-control" id="postal_code" name="mot_cle">
                                            </div>
                                        </address>
                                    </aside>
                                </div>
